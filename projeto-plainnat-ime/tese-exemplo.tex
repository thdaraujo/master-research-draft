...
\begin{center}
    ...
    \vskip 0.5cm
    \normalsize{São Paulo, agosto de 2017}
\end{center}
...
2017. 36 f. Exame de qualificação (Mestrado) - Instituto de Matemática e Estatística,
...
\begin{tabular}{ll}
        ...
        ODBA        & (\textit{Ontology-Based Data Access})\\
        OWL         & (\textit{Web Ontology Language})\\
        SGBD        & (\textit{Sistema de Gerenciamento de Banco de Dados})\\
