...
Com base nessas informações, modelamos uma ontologia utilizando OWL através do software Protégé. A estrutura básica da ontologia serve para organizar o conhecimento a respeito desses pesquisadores e sua origem acadêmica, suas publicações, e os relacionamentos que eles têm com outros. Com isso, podemos consultar essas informações estruturadas acerca da produção bibliográfica e científica dos docentes e alunos do instituto através de queries SPARQL. Essas queries geram um conjunto de dados que serve de base para esse experimento.

Partimos da ontologia Friend of a friend (FOAF), que descreve pessoas, relações e suas atividades, por ela ter alguns conceitos, classes e termos que nos auxiliam na modelagem de uma rede sociais como as redes de colaboração científica.
...
SubClassOf: Agent
Descrição: \emph{Classe que é pai de diferentes outras classes que
definem grupos de pessoas.}
Relações:
...
A ontologia foi populada com as informações dos currículos lattes, e algumas consultas também fazem parte da definição da ontologia. Essas consultas foram feitas em SPARQL. As consultas que nos interessam agora respondem às seguintes questões:
